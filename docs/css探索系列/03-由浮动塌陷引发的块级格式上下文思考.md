...
![image-20200730213436644](https://my-files-1259410276.cos.ap-chengdu.myqcloud.com/md/images/css/image-20200730213436644.png)

[查看DEMO](https://1927344728.github.io/frontend-knowledge/demo/05_float.html?type=1)
...
![image-20200730224651452](https://my-files-1259410276.cos.ap-chengdu.myqcloud.com/md/images/css/image-20200730224651452.png)
...
[查看DEMO](https://1927344728.github.io/frontend-knowledge/demo/05_float.html?type=2)
...
[查看DEMO](https://1927344728.github.io/frontend-knowledge/demo/05_float.html?type=3)

再如：我们将上一个示例的背景色模块，加上样式`display: flow-root`闭合浮动，创健了新 `BFC `，那么，它就不会影响其他 `BFC` 的元素了。如下图4：

![image-20200731003636340](https://my-files-1259410276.cos.ap-chengdu.myqcloud.com/md/images/css/image-20200731003636340.png)
...
[查看DEMO](https://1927344728.github.io/frontend-knowledge/demo/05_float.html?type=4)
